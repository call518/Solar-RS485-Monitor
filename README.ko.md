...
CREATE TABLE IF NOT EXISTS inverter_log (
    ...
    pv_voltage_v         SMALLINT UNSIGNED COMMENT 'PV 전압 (V)',
    pv_current_a         FLOAT(5,2) COMMENT 'PV 전류 (A)',
    pv_power_w           INT UNSIGNED COMMENT 'PV 출력 (W)',
    grid_voltage_v       SMALLINT UNSIGNED COMMENT '계통 전압 (V)',
    grid_current_a       FLOAT(5,2) COMMENT '계통 전류 (A)',
    current_output_w     INT UNSIGNED COMMENT '현재 AC 출력 전력 (W)',
    power_factor_pct     FLOAT(5,2) COMMENT '역률 (%)',
    frequency_hz         FLOAT(5,2) COMMENT '주파수 (Hz)',
